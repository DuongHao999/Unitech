...
namespace Thi_Dua.DAO
{
    public class DataProvider
    {
        ...
        public DataTable ExecuteQuery(string query, object[] parameter = null)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionSTR)) // dùng using thì dữ liệu sẽ được piair phóng sau khi thực hiện hoặc khối lệnh không được thực hiện
            {
                connection.Open();
